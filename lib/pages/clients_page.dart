...
class _ClientsPageState extends State<ClientsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.indigo, // Cor de fundo Indigo
        title: Text(
          widget.title,
        ...
        iconTheme: const IconThemeData(color: Colors.white), // Cor do ícone do menu hambúrguer branca
        centerTitle: true, // Centraliza o título (opcional)
        elevation: 4, // Sombra suave (opcional)
      ),
